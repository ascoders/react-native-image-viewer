    ...
    public getContent() {
                    ...
                    return (
                        ...
                        >
                            {this.props.failImageSource &&
                                <Image
                                    source={{ uri: this.props.failImageSource.url }}
                                    style={{ width: this.props.failImageSource.width, height: this.props.failImageSource.height }}
                                />
                            }
                        </Wrapper>
                    )
        ...
        return (
            ...
            >
                ...
                <Animated.View
                    style={{
                        ...this.styles.moveBox, transform: [{ translateX: this.positionX }],
