        ...
        value: function getContent() {
            ...
            var ImageElements = this.props.imageUrls.map(function (image, index) {
                ...
                if (imageInfo.status === 'success' && _this6.props.enableImageZoom) {
                    return React.createElement(index_3.default, { key: index, style: image_viewer_style_1.default.modalContainer, cropWidth: react_native_1.Dimensions.get('window').width, cropHeight: react_native_1.Dimensions.get('window').height, imageWidth: width, imageHeight: height, maxOverflow: _this6.props.maxOverflow, horizontalOuterRangeOffset: _this6.handleHorizontalOuterRangeOffset.bind(_this6), responderRelease: _this6.handleResponderRelease.bind(_this6), onLongPress: _this6.handleLongPress.bind(_this6, image), onCancel: _this6.props.onCancel }, React.createElement(react_native_1.Image, { style: [image_viewer_style_1.default.imageStyle, { width: width, height: height }], source: { uri: image.url } }));
                } else {
                    switch (imageInfo.status) {
                        case 'loading':
                            return React.createElement(react_native_1.View, { key: index, style: image_viewer_style_1.default.loadingContainer }, _this6.props.loadingRender());
                        case 'success':
                        ...
                        case 'fail':
                            return React.createElement(react_native_1.TouchableOpacity, { key: index, style: image_viewer_style_1.default.failContainer }, React.createElement(react_native_1.Image, { source: _this6.props.failImageSource, style: image_viewer_style_1.default.failImage }));
                    }
                }
            });
            return React.createElement(react_native_1.Animated.View, { style: [image_viewer_style_1.default.container, { opacity: this.fadeAnim }] }, React.createElement(react_native_1.Animated.View, { style: [image_viewer_style_1.default.moveBox, { transform: [{ translateX: this.positionX }] }, { width: react_native_1.Dimensions.get('window').width * this.props.imageUrls.length }] }, ImageElements), this.props.imageUrls.length > 1 && React.createElement(react_native_1.View, { style: image_viewer_style_1.default.count }, React.createElement(react_native_1.Text, { style: image_viewer_style_1.default.countText }, this.state.currentShowIndex + 1, "/", this.props.imageUrls.length)), this.props.imageUrls[this.state.currentShowIndex].originSizeKb && this.props.imageUrls[this.state.currentShowIndex].originUrl && React.createElement(react_native_1.View, { style: image_viewer_style_1.default.watchOrigin }, React.createElement(react_native_1.TouchableOpacity, { style: image_viewer_style_1.default.watchOriginTouchable }, React.createElement(react_native_1.Text, { style: image_viewer_style_1.default.watchOriginText }, "查看原图(2M)"))));
        }
    }, {
        key: "saveToLocal",
