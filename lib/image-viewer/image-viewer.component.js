...
var index_3 = require('nt-image-zoom');
...
var ImageViewer = function (_React$Component) {
    ...
    _createClass(ImageViewer, [{
        ...
        value: function componentWillMount() {
            ...
            var imageSizes = [];
            this.props.imageUrls.forEach(function (imageUrl) {
                imageSizes.push({
                    width: 0,
                    height: 0,
                    status: 'loading'
            ...
            this.setState({
                ...
                _this2.fadeAnim = new react_native_1.Animated.Value(0);
                _this2.loadImage(_this2.state.currentShowIndex);
        ...
        value: function loadImage(index) {
            ...
            var imageStatus = this.state.imageSizes[index];
            ...
            if (image.width && image.height) {
                ...
                react_native_1.Image.getSize(image.url, function (width, height) {
                    ...
                    if (imageLoaded && !_this3.state.imageLoaded) {
                        saveImageSize();
                    }
                }, function (error) {
                    imageStatus.status = 'fail';
        ...
        value: function saveToLocal() {
            react_native_1.CameraRoll.saveImageWithTag(this.props.imageUrls[this.state.currentShowIndex].url);
            this.setState({
                isShowMenu: false
            });
        }
        ...
        value: function render() {
            ...
            return React.createElement(react_native_1.View, __assign({}, this.props.others), this.props.visible && this.getContent(), Menu);
        }
    }]);
