                ...
                if (imageInfo.status === 'success' && _this6.props.enableImageZoom) {
                    ...
                    switch (imageInfo.status) {
                        ...
                        case 'success':
                            ...
                            return React.createElement(react_native_1.Image, { key: index, style: [_this6.styles.imageStyle, { width: width, height: height }], source: { isStatic: true, uri: image.url } });
                        case 'fail':
