    ...
    (0, _createClass3.default)(ImageViewer, [{
        ...
        value: function init(nextProps) {
            ...
            this.setState({
                ...
                _this2.positionXNumber = -_this2.width * _this2.state.currentShowIndex;
            ...
            var ImageElements = this.props.imageUrls.map(function (image, index) {
                ...
                if (imageInfo.status === 'success' && _this6.props.enableImageZoom) {
                    ...
                    switch (imageInfo.status) {
                        case 'loading':
                            return React.createElement(react_native_1.View, { key: index, style: _this6.styles.loadingContainer }, _this6.props.loadingRender());
                        case 'success':
                        ...
                        case 'fail':
                            return React.createElement(react_native_1.TouchableOpacity, { key: index, style: _this6.styles.failContainer }, React.createElement(react_native_1.Image, { source: _this6.props.failImageSource, style: _this6.styles.failImage }));
                    }
                }
            });
            return React.createElement(react_native_1.Animated.View, { style: [this.styles.container, { opacity: this.fadeAnim }] }, React.createElement(react_native_1.Animated.View, { style: [this.styles.moveBox, { transform: [{ translateX: this.positionX }] }, { width: this.width * this.props.imageUrls.length }] }, ImageElements), this.props.imageUrls.length > 1 && React.createElement(react_native_1.View, { style: this.styles.count }, React.createElement(react_native_1.Text, { style: this.styles.countText }, this.state.currentShowIndex + 1, "/", this.props.imageUrls.length)), this.props.imageUrls[this.state.currentShowIndex].originSizeKb && this.props.imageUrls[this.state.currentShowIndex].originUrl && React.createElement(react_native_1.View, { style: this.styles.watchOrigin }, React.createElement(react_native_1.TouchableOpacity, { style: this.styles.watchOriginTouchable }, React.createElement(react_native_1.Text, { style: this.styles.watchOriginText }, "查看原图(2M)"))));
        }
    }, {
        key: "saveToLocal",
